...
echo "<center><h3><b>คะแนนทีม Performance</b></h3></center>";
echo "<p align='right'><a href='include/export_point.php?file_id=$_GET[file_id]'><button class='btn btn-success'  type='submit'><img src='img/icon-excel.png' width='20' height='20'> Export Score Team Performance</button></a></p>'";
echo "<h4><b>คะแนนแบ่งตาม ทีม และ โปรเจค</b></h4>";
...
echo "<br><br><br>";
echo "<div style='width:100%;overflow:auto'>";
echo "<h4><b>คะแนนแบ่งตาม ทีม รายบุคคล และสถานะใบงาน</b></h4>";
echo "<table class='table table-bordered'>";
    echo "<thead>";
        echo "<tr>";
